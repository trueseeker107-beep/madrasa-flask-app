...
app = Flask(__name__)
app.secret_key = "dev-key-change-later"  # TODO: change in production
...
def judges():
    if request.method == "POST":
        ...
        # programme_code, student_id, student_name, judge_name are required
...
# --- Initialization for both local run and Gunicorn on Render ---
# Flask 3.x removed @app.before_first_request, so we call init_db() directly.
init_db()
